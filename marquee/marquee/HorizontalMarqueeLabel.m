...
@interface HorizontalMarqueeLabel ()<UIScrollViewDelegate>{
    NSTimer *_timer;
...
@implementation HorizontalMarqueeLabel
...
-(void)commonInit{
    self.marqueeLabelType = HorizontalMarqueeLabelTypeLeftRight;
...
-(void)drawTextInRect:(CGRect)rect {
    ...
    if (self.marqueeLabelType == HorizontalMarqueeLabelTypeLeft) {
